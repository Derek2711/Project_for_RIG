                        ...
                        <div class="container-fluid">
                            <form action="{{url('/add_product')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" min="0" class="form-control" name="price" aria-label="Amount (to the nearest dollar)" placeholder="Enter the price">
                                    <span class="input-group-text">.00</span>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">A</span>
                                    <input type="number" min="0" class="form-control" name="quantity" aria-label="Amount (to the nearest dollar)" placeholder="Enter the quantity of product">
                                    <span class="input-group-text">0</span>
                                </div>
                                <div class="input-group mb-3">
                                    <span class="input-group-text">$</span>
                                    <input type="number" min="0" class="form-control" name="discount" aria-label="Amount (to the nearest dollar)" placeholder="Enter the discount price">
                                    <span class="input-group-text">.00</span>
                                </div>
                                <div class="select">
